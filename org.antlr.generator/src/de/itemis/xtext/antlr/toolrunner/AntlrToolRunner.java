...
public class AntlrToolRunner {
	...
	public static void runWithEncodingAndParams(String grammarFullPath, String explicitEncoding, String... furtherArgs) {
		System.out.println("de.itemis.xtext.antlr.toolrunner.AntlrToolRunner.runWithEncodingAndParams");
		System.out.println("path='" + getMyJARPath() + "'");
    ...
    private static String getMyJARPath() {
		try {
			return AntlrToolRunner.class.getProtectionDomain().getCodeSource().getLocation().toURI().getPath();
		} catch (Exception ex) {
			ex.printStackTrace();
		}
		return "";
